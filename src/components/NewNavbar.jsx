...
const Navbar = () => {
  ...
  return (
    <div className="shadow-lg bg-white/35 backdrop-blur-md  sticky top-0 z-50 w-full  ">
      <div className="navbar  text-black max-w-screen-xl mx-auto">
        {/* Navbar Start */}
          ...
          <span className="text-lg md:text-2xl font-extrabold">
            ...
            <div>
              <h1 className=" hidden md:flex gap-1 text-2xl font-bold text-blue-600">
                <span className="text-black">N</span>H{" "}
                <span className="text-black">Solution</span>
              </h1>
              <p className="text-xs font-medium text-blue-500 hidden md:flex">
