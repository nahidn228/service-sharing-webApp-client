  ...
  return (
    <section className='container px-4 mx-auto py-12'>
      <div className='flex items-center gap-x-3'>
        <h2 className='text-lg font-medium text-black '>Bid Requests</h2>
                  ...
                  <tr>
                    ...
                    <td className='px-4 py-4 text-sm whitespace-nowrap'>
                      <div className='flex items-center gap-x-6'>
                        <button className='disabled:cursor-not-allowed text-black transition-colors duration-200   hover:text-red-500 focus:outline-none'>
                          <svg
                        ...
                        <button className='disabled:cursor-not-allowed text-black transition-colors duration-200   hover:text-yellow-500 focus:outline-none'>
                          <svg
                            xmlns='http://www.w3.org/2000/svg'
                            fill='none'
                            viewBox='0 0 24 24'
