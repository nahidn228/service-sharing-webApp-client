...
const Login = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-[calc(100vh-306px)] py-12 ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 overflow-hidden rounded-lg shadow-lg bg-white px-10 ">
        ...
        <div className="w-full px-6 py-8 md:px-8">
          ...
          <p className="mt-3 text-xl font-bold text-center text-black ">
          ...
          <div
            ...
            className="flex cursor-pointer items-center justify-center mt-6 text-black transition-colors duration-300 transform border rounded-lg hover:bg-[#3a31d8] hover:text-white hover:shadow-sm"
          >
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="mt-4">
              ...
              <input
                ...
                className="block w-full px-4 py-2 text-black bg-white border rounded-lg focus:border-blue-400 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40"
                type="email"
